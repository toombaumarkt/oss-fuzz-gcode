...
# METHOD 2: manually compile everything - I took all the Includes and Libraries from the command generated by qmake, but changing the dynamic ones to static libraries does not work either
